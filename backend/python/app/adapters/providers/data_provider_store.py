...
def get_data_provider_settings_path() -> Path:
    default_path = Path(__file__).resolve().parent.parent.parent.parent.parent.parent / "config" / "data-providers.json"
    legacy_path = Path(__file__).resolve().parent.parent.parent.parent / "config" / "data-providers.json"
